class Family < ActiveRecord::Base
  belongs_to :address
  has_many :care_requests, class_name: 'CareRequest', foreign_key: :requesting_family_id
  has_many :children
  has_many :credits
  has_many :guardians
  has_many :hosted_care_requests, class_name: 'CareRequest', foreign_key: :host_family_id
